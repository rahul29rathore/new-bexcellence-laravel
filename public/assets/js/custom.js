$(function() {
	...
	$('.panel-switcher a').click(function(){
		$('.panel-switcher a').removeClass('active');
		$(this).addClass('active');
	})

	$('.header-toggle').on('click',function(){
		$('.main-header,.jumps-prevent').toggleClass('active');
		$('.header-toggle i').toggleClass('fa-angle-up fa-angle-down');
	})

	//====hide table column=====//
	
    $('.optWrapper ul li').click(function(){
        var indexNum = $(this).index();
		//console.log(indexNum + 1);
        $('.table tr th:nth-child('+ (indexNum + 1) +'),.table tr td:nth-child('+ (indexNum + 1) +')').toggle();
    })
	//====hide table column end=====//
...
function printDiv() 
{
	var divToPrint=document.getElementById('pr-invoice');
